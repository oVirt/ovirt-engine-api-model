...
4.6.1 / Oct 14 2025
    ...
    Add VideoType under Display

    Build for CentOS 10

    Add description string field to OperatingSystem

    Add attach_wgt flag to vm start endpoint

    Added activePaths to LogicalUnit model

    Add EngineBackupInfo containing last backups

    Drop CentOS 8 builds
...
4.5.10 / Jun 14 2022
    ...
    Add parallel migration connections
    https://bugzilla.redhat.com/2078500

    Introduce isolate threads CpuPinningPolicy
    https://bugzilla.redhat.com/1782077
...
4.5.6 / Mar 29 2022
    ...
    Remove whitespace which interferes with
    sdk generation
...
4.5.5 / Mar 28 2022
    ...
    https://bugzilla.redhat.com/2040474

    Added Display.disconnectActionDelay
    https://bugzilla.redhat.com/1944834
