...
IMPORTANT: All `curl` examples include placeholders for authentication
details (`USER:PASS`) and certificate location (`CERT`). Ensure all
requests performed with `curl` fulfill certification and authentication
requirements.
...
--header 'Accept: application/xml' \
--user '[USER:PASS]' \
https://[HOST]/ovirt-engine/api/clusters
....
...
The `networks` link is a reference to the <<services/assigned_networks,
...
--header 'Accept: application/xml' \
--user '[USER:PASS]' \
https://[HOST]/ovirt-engine/api/networks
....
...
--header 'Accept: application/xml' \
--user '[USER:PASS]' \
https://[HOST]/ovirt-engine/api/hosts
....
...
' \
https://[HOST]/ovirt-engine/api/storagedomains
....
...
' \
https://[HOST]/ovirt-engine/api/datacenters/001/storagedomains
....
...
' \
https://[HOST]/ovirt-engine/api/vms
....
...
' \
https://[HOST]/ovirt-engine/api/vms/007/nics
....
...
' \
https://[HOST]/ovirt-engine/api/vms/007/diskattachments
....
...
--header 'Version: 4' \
--header 'Accept: application/xml' \
https://[HOST]/ovirt-engine/api/storagedomains/006/files
....
...
' \
https://[HOST]/ovirt-engine/api/vms/007/cdroms/00000000-0000-0000-0000-000000000000
....
...
' \
https://[HOST]/ovirt-engine/api/vms/007/start
....
