...
[id="Changes-in-API-version-4-0-succeeding-version-3-6"]
...
[id="Removed-the-capabilities.permits-element"]
...
[id="Use-multiple-boot.devices.device-instead-of-multiple-boot"]
...
[id="Removed-the-disks.clone-and-disks.detach_only-elements"]
...
[id="Removed-the-snapshots.collapse_snapshots-element"]
...
[id="Removed-the-permissions.clone-element"]
...
[id="Removed-the-intermediate-tag.parent-element"]
...
[id="Removed-the-bricks.replica_count-and-bricks.stripe_count-elements"]
...
[id="Use-multiple-vcpu_pins-vcpu_pin-instead-of-multiple-vcpu_pin"]
...
[id="Removed-the-scheduling_policy.policy-element"]
...
[id="Openstack-Volume-Cinder-integration-replaced-by-Managed-Block-Storage"]
