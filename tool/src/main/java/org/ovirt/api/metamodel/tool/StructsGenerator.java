...
public class StructsGenerator extends JavaGenerator {
    ...
    private void generateBuilderMethods(StructType struct, StructMember member) {
        ...
        if (type instanceof PrimitiveType) {
            ...
            // Add one method that sets the list from an array of objects:
            ...
            // Add one method that adds a list to the list of objects:
            javaBuffer.addImport(ArrayList.class);
            ...
            // Add one method that adds an array of objects to the list:
            javaBuffer.addImport(Collections.class);
            javaBuffer.addLine("public %1$s add%3$s(%2$s... new%3$s) {",
                thisName.getSimpleName(), elementReference.getText(), property);
            javaBuffer.addLine(  "if (new%1$s != null) {", property);
            ...
            // If the elements of the list are structs, then generate additional methods that take builders of the
            // element type as parameter:
            if (elementType instanceof StructType) {
                JavaClassName builderName = javaTypes.getBuilderName(elementType);

                // Generate a method that sets elements from an array of builders:
                javaBuffer.addImport(builderName);
                javaBuffer.addImport(ArrayList.class);
                javaBuffer.addLine("public %1$s set%3$s(%2$s... new%3$s) {",
                    thisName.getSimpleName(), builderName.getSimpleName(), property);
                ...
                javaBuffer.addLine(      "if (builder != null) {");
                ...
                // Generate a method that adds items from an array of builders:
                javaBuffer.addImport(builderName);
                javaBuffer.addImport(ArrayList.class);
                javaBuffer.addLine("public %1$s add%3$s(%2$s... new%3$s) {",
                    thisName.getSimpleName(), builderName.getSimpleName(), property);
